...
export const metadata = { title: "プライバシーポリシー | Ai-SESマッチング" };
...
export default function PrivacyPage() {
  return (
    <article>
      ...
      <p className={p + " mt-4"}>
        株式会社eビジネスソリューション（以下「当社」といいます）は、Ai-SESマッチングプラットフォーム「Ai-SESマッチング」
      ...
      <p className={p}>
        事業者名: 株式会社eビジネスソリューション／所在地: 東京都江東区塩浜２－１３－９／
