...
export default function PrivacyPage() {
  return (
    <article>
      ...
      <p className={p + " mt-4"}>
        株式会社ｅビジネスソリューション（以下「当社」といいます）は、AI人材・案件ダイレクトマッチングプラットフォーム「SES DirectMatch」
      ...
      <p className={p}>
        事業者名: 株式会社ｅビジネスソリューション／所在地: 東京都江東区塩浜２－１３－９／
        代表者: 郭亮／個人情報保護管理者: 取締役 上野建二
      </p>
      ...
      <ol className="list-decimal pl-5">
        <li className={li}>
          ...
          企業実名・実額契約金額・健康/家族情報・在留証憑は送信しません。国籍（国名）・性別・年齢は、本サービスの提供に必要な範囲でAIによる抽出の対象とします。
        </li>
        <li className={li}>
