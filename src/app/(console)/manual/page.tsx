    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="space-y-5">
        ...
        <Section id="projects" title="案件">
          ...
          <p>
            案件の進行状態（応募中／商談中／成約／終了）は、商談・契約の進行に連動して自動更新されますが、手動で上書きもできます。
          </p>
        </Section>
        ...
        <Section id="entries" title="商談管理">
          <p>
            商談（提案・スカウト）の送受信、承認、面談、メッセージ、条件調整をここで扱います。呼称は画面上「商談」で統一しています。
          </p>
          <Steps
            items={[
        ...
        <Section id="glossary" title="用語集">
          <dl className="space-y-2">
            {[
              ...
              ["進行状態（案件）", "応募中／商談中／成約／終了。同じく自動更新（手動上書き可）。"],
